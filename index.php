 	...
 	?>
			 ...
			 <div class="post">
                    ...
                    <span class="line"></span>
                     ...
                     <span class="blue"><?php echo $yqlfeed2->query->results->item[$i++]->comments[1]; ?> Comments </span>
           ...
           <a class="button right" href="<?php echo $logoutUrl; ?>"><span class="buttonimage left"></span>Logout</a>
            ...
            <div class="tabHeader">Categories on webdesigntuts+</div>
                ...
                <?php  foreach($yqlfeed3->query->results->item as $item) { ?>
                    <li><a href="http://webdesign.tutsplus.com/tag/<?php echo str_replace(' ','+',$item->category);?>" target="_blank"><?php echo $item->category;?></a></li>
              <?php }?>
                </ul>
